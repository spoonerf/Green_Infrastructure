...
ggplot(df_hab, aes(x = treeProp+shrubProp+grassProp, y = auc_bio, group = site,colour = as.factor(month(df_hab$EndDate))))+
  geom_jitter(width = 0.2)
```

```{r}

ggplot(df_hab, aes(x = treeArea, y = auc_anthro, group = site,colour = site))+
  geom_jitter(width = 0.2)+ 
...
ggplot(df_hab, aes(x = treeArea + shrubArea , y = peak_bio, group = site,colour =  Site_Type))+
  geom_jitter(width = 0.2)
...
ggplot(df_hab, aes(x =  shrubArea, y = auc_bio, group = site,colour = site))+
  geom_jitter(width = 0.2)+ 
  theme(legend.position = "none")
